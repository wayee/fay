package mm.fay
{
	 ...
	 * 
	 */
	public class FSlider extends Component
	{
		...
		/**
		 * Constructor
		 * @param orientation Whether the FSlider will be horizontal or vertical.
		 * @param defaultHandler The event handling function to handle the default event for this component (change in this case).
		 * @param parent The parent DisplayObjectContainer on which to add this FSlider.
		 * @param xpos The x position to place this component.
		 * @param ypos The y position to place this component.
		 */
		public function FSlider(orientation:int = FConst.HORIZONTAL, defaultHandler:Function = null, parent:DisplayObjectContainer = null, xpos:Number = 0, ypos:Number = 0)
		{
		...
		{
			_back = new Sprite();
			_back.filters = [Style.getShadow(2, true)];
			addChild(_back);
			
			_handle = new Sprite();
			_handle.filters = [Style.getShadow(1)];
