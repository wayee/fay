...
{
	/**
	 * FColor object to set color and alpha for a movieclip.
	 *  
	...
	public class FColor
	{
		public static const WHITE:FColor = new FColor(0xffffff);
		public static const LIGHT_GRAY:FColor = new FColor(0xc0c0c0);
		public static const GRAY:FColor = new FColor(0x808080);
		public static const DARK_GRAY:FColor = new FColor(0x404040);
		public static const BLACK:FColor = new FColor(0x000000);
		public static const RED:FColor = new FColor(0xff0000);
		public static const PINK:FColor = new FColor(0xffafaf);
		public static const ORANGE:FColor = new FColor(0xffc800);
		public static const HALO_ORANGE:FColor = new FColor(0xFFC200);
		public static const YELLOW:FColor = new FColor(0xffff00);
		public static const GREEN:FColor = new FColor(0x00ff00);
		public static const HALO_GREEN:FColor = new FColor(0x80FF4D);
		public static const MAGENTA:FColor = new FColor(0xff00ff);
		public static const CYAN:FColor = new FColor(0x00ffff);
		public static const BLUE:FColor = new FColor(0x0000ff);
		public static const HALO_BLUE:FColor = new FColor(0x2BF5F5);
		...
		public function FColor (rgb:uint=0x000000, alpha:Number=1)
		{
			this.rgb = rgb;
		 ...
		 */
		public function changeAlpha(newAlpha:Number):FColor
		{
			return new FColor(getRGB(), newAlpha);
		}
		 ...
		 * @return the new <code>ASColor</code>
		 */	
		public function changeHue(newHue:Number):FColor
		{
		 ...
		 * @return the new <code>ASColor</code>
		 */	
		public function changeLuminance(newLuminance:Number):FColor
		{
		 ...
		 * @return the new <code>ASColor</code>
		 */	
		public function changeSaturation(newSaturation:Number):FColor
		{
		 ...
		 */
		public function scaleHLS(hScale:Number, lScale:Number, sScale:Number):FColor
		{
		 ...
		 */
		public function offsetHLS(hOffset:Number, lOffset:Number, sOffset:Number):FColor
		{
		 ...
		 * @see        #brighter()
		 */		
		public function darker(factor:Number=0.7):FColor
		{
			var r:uint = getRed();
			var g:uint = getGreen();
			var b:uint = getBlue();
		...
		public function enabled(red:Number=0.7, green:Number=0.7, blue:Number=0.7):FColor
		{
			var r:uint = getRed();
			var g:uint = getGreen();
			var b:uint = getBlue();
			return getASColor(r*red, g*green, b*blue, alpha);
		}
		 ...
		 * @see        #darker()
		 */	
		public function brighter(factor:Number=0.7):FColor
		{
			var r:uint = getRed();
			var g:uint = getGreen();
			var b:uint = getBlue();
		 ...
		 */
		public static function getASColor(r:uint, g:uint, b:uint, a:Number=1):FColor
		{
			return new FColor(getRGBWith(r, g, b), a);
		}
		 ...
		 * @return the ASColor
		 */
		public static function getWithARGB(argb:uint):FColor
		{
			var rgb:uint = argb & 0x00FFFFFF;
			var alpha:Number = (argb >>> 24)/255;
			return new FColor(rgb, alpha);
		}
		 ...
		 * @param a alpha channel
		 */	
		public static function getASColorWithHLS(h:Number, l:Number, s:Number, a:Number=1):FColor
		{
			var c:FColor = new FColor(0, a);
			c.hlsCounted = true;
		...
		{
			return new FColor(getRGB(), getAlpha());
		}
		
		public function toString():String
		{
			return "FColor(rgb:"+rgb.toString(16)+", alpha:"+alpha+")";
		}
	}
}